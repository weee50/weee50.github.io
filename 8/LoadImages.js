...
Textures = {Ground:[], Closed:[], Mine:[], OpenedMine:[], FinalFlag:[], Half:[], GroundLeft:[], GroundRight:[]};
...
function createTextures(){
  ...
  for(i=0;i<10;i++){
    Textures.GroundLeft[i] = new Image();
    Textures.GroundLeft[i].src = "GroundLeft_" + i + ".png";
    Textures.GroundRight[i] = new Image();
    Textures.GroundRight[i].src = "GroundRight_" + i + ".png";
  }
  for(i=-1;i<4;i++){
