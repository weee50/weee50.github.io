      ...
      if(GameState == 3){
        if(field[i][j].mines != 0){
          ...
          if (field[i][j].half == 0) {
            ...
            cont.drawImage(Textures.Half[field[i][j].neighbours], screenscale * i, screenscale * j, screenscale, screenscale);
          }
...
function digAround(posX, posY){
  ...
  for(i = 0; i < z.length; i++){
    ...
    if(!field[sx][sy].open){
        ...
        if(field[sx][sy].neighbours == 0 && field[sx][sy].half == 0){
            digAround(sx,sy);
        }
    }
  }
...
function leftClick(posX, posY){
        ...
        for(i = 0; i < r.length; i++){
          if((field[r[i][0]][r[i][1]].flags == 0) && !field[r[i][0]][r[i][1]].open){
            ...
            if(field[r[i][0]][r[i][1]].mines != 0){
              ...
              if(field[r[i][0]][r[i][1]].neighbours == 0 && field[r[i][0]][r[i][1]].half == 0){
  ...
  if(field[posX][posY].mines != 0){
    ...
    if(field[posX][posY].neighbours == 0 && field[posX][posY].half == 0){
      digAround(posX, posY);
    }
  }
  drawStuff();
